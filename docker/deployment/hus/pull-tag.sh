...
docker pull hfdtu3132022aiccelparkprivatecr.azurecr.io/srdc/tofhir-engine:latest
docker tag  hfdtu3132022aiccelparkprivatecr.azurecr.io/srdc/tofhir-engine:latest srdc/tofhir-engine:latest
